...
import { Plus, Zap, Code, BarChart3, Layers, Play, Calendar, Clock, Trash2, Copy } from "lucide-react"
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 -m-4 p-8">
            <main className="container mx-auto px-4 py-8">
              ...
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold text-gray-900 mb-4">Build Neural Networks Visually</h2>
                <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                  Drag, drop, and connect PyTorch modules to create powerful deep learning models. No coding required -
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                  {[
                    { icon: Layers, title: "Drag & Drop", desc: "Visual module composition", color: "text-blue-600" },
                    {
                      icon: Zap,
                    ...
                    { icon: BarChart3, title: "Analytics", desc: "Performance insights", color: "text-purple-600" },
                    { icon: Code, title: "Export Code", desc: "Generate PyTorch scripts", color: "text-orange-600" },
                  ].map((feature, index) => (
                      ...
                      <CardContent>
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex space-x-2">
                            <Badge variant={getModelTypeVariant(workspace.modelType)}>{workspace.modelType}</Badge>
              ...
              <div className="bg-white rounded-xl p-8 shadow-sm border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    >
                      <div className={`w-8 h-8 ${template.bgColor} rounded-lg flex items-center justify-center mb-2`}>
