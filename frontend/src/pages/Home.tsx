                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Visual Deep Learning Platform</p>
                            </div>
                        </div>
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                        Drag, drop, and connect PyTorch modules to create powerful deep learning models. No coding
                        required - just pure visual creativity.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <CardHeader className="pb-3">
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            <CardTitle
                                                className="text-lg group-hover:text-blue-600 transition-colors">{workspace.name}</CardTitle>
                                ...
                                <CardContent>
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex space-x-2">
                                            <Badge
                                                variant={getModelTypeVariant(workspace.modelType)}>{workspace.modelType}</Badge>
                                            <Badge
                                                variant={getStatusVariant(workspace.status)}>{workspace.status}</Badge>
                                        </div>
                                    </div>
                        ...
                        >
                            <CardContent className="flex flex-col items-center justify-center h-full py-12">
                                ...
                                <p className="text-sm text-muted-foreground text-center">Start building your next neural
                                    network</p>
                            </CardContent>
                        </Card>
                    </div>
